Day4 のハンズオンのコピー＆ペースト用コマンドリストです。
...
scp -i udemy-aws-14days.pem udemy-aws-14days.pem ec2-user@(Web-1aインスタンスの Public IP アドレス):/home/ec2-user
...
curl http://(Web EC2 インスタンス の Public IP アドレス)/
```